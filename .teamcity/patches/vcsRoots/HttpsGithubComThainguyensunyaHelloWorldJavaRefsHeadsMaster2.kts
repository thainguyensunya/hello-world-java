...
To apply the patch, create a vcsRoot with id = 'HttpsGithubComThainguyensunyaHelloWorldJavaRefsHeadsMaster2'
in the root project, and delete the patch script.
*/
create(DslContext.projectId, GitVcsRoot({
    id("HttpsGithubComThainguyensunyaHelloWorldJavaRefsHeadsMaster2")
